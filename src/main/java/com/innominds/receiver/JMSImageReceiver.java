...
public class JMSImageReceiver implements MessageListener, InitializingBean {

    private static final Logger LOG = LoggerFactory.getLogger( JMSImageReceiver.class );
